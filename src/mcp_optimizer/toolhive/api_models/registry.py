...
class KubernetesMetadata(BaseModel):
    ...
    name: str | None = Field(None, description='Name is the Kubernetes resource name')
    ...
    uid: str | None = Field(None, description='UID is the Kubernetes resource UID')


class Metadata(BaseModel):
    kubernetes: KubernetesMetadata | None = None
    last_updated: str | None = Field(
        None,
        description='LastUpdated is the timestamp when the server was last updated, in RFC3339 format',
    )
    pulls: int | None = Field(
        None,
