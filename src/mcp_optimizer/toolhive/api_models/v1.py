...
from . import skills as skills_1
...
class BuildSkillRequest(BaseModel):
    path: str | None = Field(None, description='Path to the skill definition directory')
    tag: str | None = Field(None, description='OCI tag for the built artifact')
...
class BulkClientRequest(BaseModel):
    ...
    names: list[client.ClientApp] | None = Field(
...
class ClientStatusResponse(BaseModel):
    clients: list[client.ClientAppStatus] | None = None
...
class CreateClientRequest(BaseModel):
    ...
    name: client.ClientApp | None = None
...
class InstallSkillRequest(BaseModel):
    name: str | None = Field(
        None, description='Name or OCI reference of the skill to install'
    )
    scope: skills_1.Scope | None = None
    version: str | None = Field(
        None, description='Version to install (empty means latest)'
    )
...
class PushSkillRequest(BaseModel):
    reference: str | None = Field(None, description='OCI reference to push')
...
class UninstallSkillRequest(BaseModel):
    name: str | None = Field(None, description='Name of the skill to uninstall')
    scope: skills_1.Scope | None = None
...
class InstallSkillResponse(BaseModel):
    skill: skills_1.InstalledSkill | None = None
...
class SkillListResponse(BaseModel):
    skills: list[skills_1.InstalledSkill] | None = Field(
        None, description='List of installed skills'
    )
